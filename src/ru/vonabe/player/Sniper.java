...
public class Sniper extends Unit {
    ...
    public Sniper(int weapons, int protection, int health, int techno_weapons, int techno_protection, int techno_health, boolean attack_techno_all,
